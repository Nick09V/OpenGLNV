...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Exercise 13 Task 3", NULL, NULL);
    if (window == NULL)
    {
    ...
    // ------------------------------------
    Shader lightingShader("shaders/shader_exercise13t3_colors.vs", "shaders/shader_exercise13t3_colors.fs");
